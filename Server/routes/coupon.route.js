const { create, update, deleteCoupon, getAll, getCoupon } = require("../controllers/coupon.controller");
...
route.delete("/:id", authController.isSignIn, authController.isEditor, deleteCoupon);
